...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   gr_vm_camera_handling_rot.c                        :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tsedigi <marvin@42.fr>                     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/08/01 05:16:33 by tsedigi           #+#    #+#             */
/*   Updated: 2017/08/01 05:16:35 by tsedigi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		cam_trans_up(void *data, t_gr_vm *vm, t_key *key)
{
	...
	vm->camera.m.r[1].w -= tr.y;
	vm->camera.m.r[2].w -= tr.z;
<<<<<<< HEAD:srcs/corewar_srcs/gr_vm_camera_handling_rot.c
}
=======
	(void)data;
	(void)key;
}
>>>>>>> 378561dd66dc5ff65f2a4e739cce3748d7e2ccb1:srcs/corewar_srcs/graphics/gr_vm_camera_handling_rot.c
